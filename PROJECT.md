...
- **Do not create historical shims.** After a refactor or move, update callers and documentation to the canonical API instead of adding aliases, forwarding modules, deprecated wrappers, or other compatibility layers solely to preserve former names or paths.
