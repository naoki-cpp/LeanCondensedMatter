...
description: Behavior-preserving refactor pass over this project's Lean files — find duplicated proof idioms, extract them as named lemmas, verify, and open a PR. Use when the user asks to refactor, clean up, or dedupe Lean code.
---
