...
| Normalized source generating functional | Finite-set source moments after vacuum normalization, with connected coefficients obtained by the cumulant transform. It is statistics-independent and does not introduce Grassmann variables. | `SecondQuantization.Common.GeneratingFunctional`, `powerSeriesGeneratingFunctional` |
