...
The initial cross-cutting refactor has been applied. CI findings are used to complete downstream API and section-variable cleanup. The temporary inventory workflow will be removed before merge.
