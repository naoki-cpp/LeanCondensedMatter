...
**Still needed:** `energyExpValue`/`helmholtzFreeEnergy_ge`/`vonNeumannEntropy_gibbsState` (the Gibbs–Klein / free-energy-minimization content built on top of `gibbsState` in the finite-dimensional file) are not yet ported.
