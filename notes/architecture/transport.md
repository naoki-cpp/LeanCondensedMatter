...
iteration, and conditional resummation/uniqueness under an explicit inverse of `I - L_RA`. It does
not expose separate one-rung or residual routing APIs and does not assume convergence or a Ward
identity.
