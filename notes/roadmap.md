...
| Independent replica-method formal linked-cluster proof | B/C/D | `idea` | [linked-cluster theorem](roadmaps/linked-cluster-theorem.md#replica-method-proof-track) |
