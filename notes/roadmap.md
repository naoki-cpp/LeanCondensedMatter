...
| Moment factorization under independence (towards connected cumulants) | B | `stated` | [notes/roadmaps/combinatorics.md](roadmaps/combinatorics.md#moment-factorization-under-independence-towards-connected-cumulants) |
...
| Second quantization, fermionic primary line (Fock space, CAR, Hamiltonians, Dyson expansion) | D | `stated` (phases 1-7 done) | [notes/roadmaps/second-quantization.md](roadmaps/second-quantization.md) |
