...
| Moment factorization under independence (towards connected cumulants) | B | `proved` | [notes/roadmaps/combinatorics.md](roadmaps/combinatorics.md#moment-factorization-under-independence-towards-connected-cumulants) |
