...
| Second quantization, fermionic primary line (Fock space, CAR, Hamiltonians, Dyson expansion) | D | `stated` (phases 1-7 done; phase 9 in progress — statistics-agnostic KMS/trace-cyclicity/2-point Bloch–de Dominicis base case done for both statistics, general peel-first machinery + 4-point reduction done, full n-point induction not yet started) | [notes/roadmaps/second-quantization.md](roadmaps/second-quantization.md) |
