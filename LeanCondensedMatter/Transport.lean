...
resolvent formulations, finite pure-point Kubo–Bastin, Středa integration/trace theory, occupation
interpolation, finite disorder, and concrete anomalous-Hall benchmarks.
