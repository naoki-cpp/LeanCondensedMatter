...
resolvent formulations, finite pure-point and occupation-resolved Kubo–Bastin, Středa
integration/trace theory, occupation interpolation, finite disorder, and concrete anomalous-Hall
benchmarks.
