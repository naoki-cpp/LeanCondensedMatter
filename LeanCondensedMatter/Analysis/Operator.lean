...
Public routing module for the generic operator-theory endpoints exported by
`LeanCondensedMatter.Analysis`. Concrete realizations such as real-line `L²` multiplication,
