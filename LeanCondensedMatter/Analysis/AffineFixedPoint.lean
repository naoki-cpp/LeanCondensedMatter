...
This module records the additive algebra behind linear ladder fixed-point equations. No
finite-dimensionality, topology, norm, commutativity, or linear structure is required: uniqueness
follows whenever the shifted map `x ↦ x - f x` is injective.
-/
