...
noncomputable def internalOperator (S : InternalMatrix) : Spinor →ₗ[ℂ] Spinor where
...
@[simp]
theorem internalOperator_apply (S : InternalMatrix) (ψ : Spinor) (a : Fin 2) :
...
noncomputable def hamiltonian
    (κ : ℝ) (potential : Spatial) (internalH : InternalMatrix) : Spinor →ₗ[ℂ] Spinor :=
