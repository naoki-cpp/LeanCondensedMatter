...
/-!
# Refinement fibers of finite set partitions

Refinements of a partition are independent choices of a partition on every block. This module
contains the structural equivalence and order isomorphism, without incidence-algebra machinery.
-/
