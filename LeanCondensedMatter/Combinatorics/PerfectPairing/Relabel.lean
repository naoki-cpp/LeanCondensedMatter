...
positions. -/
def Pairing.transport {α β : Type*} (P : PairingOn β) (e : α ≃ β) : PairingOn α where
...
@[simp]
theorem Pairing.transport_partner {α β : Type*} (P : PairingOn β)
    (e : α ≃ β) (i : α) :
...
def Pairing.transportEquiv {α β : Type*} (e : α ≃ β) :
...
@[simp]
theorem Pairing.transport_symm_transport {α β : Type*} (P : PairingOn β)
    (e : α ≃ β) :
...
@[simp]
theorem Pairing.transport_transport_symm {α β : Type*} (P : PairingOn α)
    (e : α ≃ β) :
    (P.transport e.symm).transport e = P := by
  ext i
  simp

theorem Pairing.transport_trans {α β γ : Type*} (P : PairingOn γ)
    (e : β ≃ γ) (f : α ≃ β) :
...
positions. -/
def Pairing.relabel {α : Type*} (P : PairingOn α) (e : Equiv.Perm α) : PairingOn α :=
  P.transport e

@[simp]
theorem Pairing.relabel_partner {α : Type*} (P : PairingOn α) (e : Equiv.Perm α)
...
def Pairing.relabelEquiv {α : Type*} (e : Equiv.Perm α) : PairingOn α ≃ PairingOn α :=
  Pairing.transportEquiv e

@[simp]
theorem Pairing.relabel_refl {α : Type*} (P : PairingOn α) :
    P.relabel (Equiv.refl α) = P := by
  ext i
  simp

@[simp]
theorem Pairing.relabel_symm_relabel {α : Type*} (P : PairingOn α) (e : Equiv.Perm α) :
    (P.relabel e).relabel e.symm = P := by
  ext i
  simp

@[simp]
theorem Pairing.relabel_relabel_symm {α : Type*} (P : PairingOn α) (e : Equiv.Perm α) :
    (P.relabel e.symm).relabel e = P := by
  ext i
  simp

theorem Pairing.relabel_trans {α : Type*} (P : PairingOn α) (e f : Equiv.Perm α) :
