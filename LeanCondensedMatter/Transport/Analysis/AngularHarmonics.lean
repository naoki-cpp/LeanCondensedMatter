...
Model-independent complex-valued trigonometric integrals used by angular reductions in transport
calculations.  Only the first and second harmonics currently needed by downstream consumers are
exposed here; no general Fourier API is introduced.
-/
