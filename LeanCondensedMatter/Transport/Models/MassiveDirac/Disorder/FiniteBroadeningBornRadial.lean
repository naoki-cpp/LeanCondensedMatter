...
This module owns radial propagator-level combinations reused by current-vertex and zero-broadening
consumers. No vertex algebra or limiting procedure is introduced here.
-/
