...
The closed Berry-curvature benchmark is recorded directly here; its connection to generic spectral
Berry geometry is proved downstream by the intrinsic-response bridge.
