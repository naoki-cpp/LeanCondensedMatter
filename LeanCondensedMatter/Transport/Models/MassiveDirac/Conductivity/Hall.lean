...
benchmark. Formalism-specific analysis, including finite-`η` Středa momentum integration and radial
reduction, remains upstream under the corresponding Bastin/Středa owners; this layer attaches the
physical conductivity normalization and exposes conductivity-level results.
-/
