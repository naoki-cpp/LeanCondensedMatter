...
API, radial kinematics, spectral occupation and Fermi-surface kinematics, and matrix/operator
spectral-projector algebra. Canonical implementations live under `Transport/Models/MassiveDirac/Model/`.
-/
