...
Public umbrella for the model-specific Bastin/Středa trace identity, shared-provenance fixed-momentum
response matrix, and the finite-`η` Born-Dyson RA-dressed/bare-same-side Hall surface trace bridge.
The generic finite-energy surface/sea integration layer is owned by `Transport.Streda`. Physical
