...
Dirac model.  The current implementation exposes the finite relaxation-time approximation; later
Kubo/disorder work must derive its transport lifetime rather than identifying it with a
single-particle broadening by definition.
-/
