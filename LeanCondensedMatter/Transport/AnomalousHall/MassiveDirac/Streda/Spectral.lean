...
is a left inverse of `z I - H₀`.  At positive retarded/advanced broadening the generic resolvent is
the corresponding two-projector expansion.  This is the spectral bridge needed before expanding
the Bastin/Středa trace into interband projector traces and comparing it with Berry curvature.
-/
