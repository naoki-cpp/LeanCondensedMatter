...
The inner/outer error split previously implemented here is now a private detail of the generic
`Transport.Analysis.LorentzianPole` theorem.  This file is retained temporarily so historical module
