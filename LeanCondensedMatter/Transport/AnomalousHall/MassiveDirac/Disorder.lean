...
imaginary parts into logarithmic norm and principal-argument differences, and exposes the real-part
cutoff dependence through the corresponding quartic real denominator polynomial.  UV and
