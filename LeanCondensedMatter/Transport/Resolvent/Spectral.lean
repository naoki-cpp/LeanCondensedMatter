...
Retarded and advanced results are obtained by choosing `SpectralSide.retarded` or
`SpectralSide.advanced`, rather than by maintaining duplicate theorem families.
