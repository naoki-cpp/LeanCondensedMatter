...
self-energy relation, their pure-point spectral action, real-energy derivatives, uniqueness of
side-indexed resolvent candidates, and the reusable scalar Lorentzian pole kernel.
