...
pairing, while position transport factors through the standard component-leg fiber. Their endpoint
coordinates agree up to normalized-pair swap, and agree exactly whenever component position order is
preserved.
-/
