...
finite-order Dyson coefficients valid for arbitrary configuration types. The remaining continuous-
operator realization, norm bounds, analytic evolution, trace series, and exponential identities are
