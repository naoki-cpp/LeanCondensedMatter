...
diagrams with distinguished external legs, their full component partitions, and vacuum-component
restrictions; ordered diagram data, connected components, component-local orders, order-preserving
shuffle decompositions, and shuffled ordered-simplex integrands; component restriction and
