...
and total-number operator on their natural weighted `ℓ²` domains.

Closedness, adjoints, self-adjointness, and trace-class thermal constructions remain later analytic
work.
-/
