...
Finite-basis weighted and Gibbs expectations, the free partition function and occupation numbers,
free two-point functions and contractions, and concrete Bloch–de Dominicis specializations.
-/
