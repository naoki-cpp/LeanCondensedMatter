...
It exposes canonical Gibbs expectations, including integrable unbounded diagonal expectations,
partition functions, Fermi--Dirac observables, entropy, Green functions and contractions,
pure-point Gibbs summability, and completed free-Gibbs
