...
probability and charge current representations.  No claim is made here about continuum orbital
angular momentum, whose localization commutator is not of this internal-degree form.
-/
...
noncomputable def schwartzOperatorProbabilityCurrentRepresentation1D
  ...
  conventionalCurrentRepresentation SchwartzOneParticle1D ℏ
    ...
    (fun α => by
      simpa using linearCommutator_smul_id_right
...
noncomputable def schwartzOperatorChargeCurrentRepresentation1D
  ...
  conventionalCurrentRepresentation SchwartzOneParticle1D ℏ
    ...
    SchwartzKinetic1D.multiplicationLinear
    (schwartzHeisenbergLocalizationFactorsThroughDifferential1D ℏ κ potential)
    (fun α => linearCommutator_smul_id_right
