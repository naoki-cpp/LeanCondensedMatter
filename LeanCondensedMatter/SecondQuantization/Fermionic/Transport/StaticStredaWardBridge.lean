...
The same bridge is additionally stated componentwise for independent measured-current and
source-field directions. The historical one-direction Ward API below is left unchanged.
