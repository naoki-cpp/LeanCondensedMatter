...
leg, pairing, pair-product, crossing compatibility, cross-component block inversion counts, and the
reduction of pairing-weight factorization to external-crossing parity; the Dyson diagram expansion,
connected-component decomposition, and scalar-prefactor factorization.
-/
