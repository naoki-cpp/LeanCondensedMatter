...
counts, pairing-weight factorization, and contraction-integrand factorization over connected
components; the Dyson diagram expansion, connected-component decomposition, and scalar-prefactor
factorization.
-/
