...
pairing, and final Wick-diagram reindexing modules. Public theorems are exposed through this entry
point; coordinate Gibbs-expectation calculations remain private proof machinery.
-/
