...
full components, factorization of mixed-time contraction products, decomposition of mixed crossing
counts and conditional pairing weights, fixed-time diagram amplitudes, and the ordered-simplex
