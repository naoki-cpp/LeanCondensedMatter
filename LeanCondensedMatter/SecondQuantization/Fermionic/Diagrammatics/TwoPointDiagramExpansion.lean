...
Atomic flattening and the finite-temperature pairing expansion for the imaginary-time two-point
function with quartic interaction vertices. Reindexing pairings into external-leg Wick diagrams is
the next layer.
-/
