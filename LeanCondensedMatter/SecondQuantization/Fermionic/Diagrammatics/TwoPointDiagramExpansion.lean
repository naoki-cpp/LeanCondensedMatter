...
family of interaction slots, and the exchange of the finite diagram sum with the ordered-simplex
integral. The umbrella exports authoritative owner modules rather than the
