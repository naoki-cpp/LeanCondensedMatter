...
theorem FixedExternalTwoPointWickDiagram.mixedComponentCrossingPreserving_of_componentTimeEq
  ...
  have hqEnds :
    ...
    simpa [tq, q0, q1] using
      d.mixedComponentPairTimeEquiv_endpoints_eq τ τ' σ υ B hTime q
  have hp0Val :
  ...
  have h00 := d.mixedComponentPositionTimeEquiv_lt_iff
    τ τ' σ υ B hTime p0 q0
  have h01 := d.mixedComponentPositionTimeEquiv_lt_iff
    τ τ' σ υ B hTime q0 p1
  have h11 := d.mixedComponentPositionTimeEquiv_lt_iff
    τ τ' σ υ B hTime p1 q1
  unfold Crosses
  constructor
  · rintro ⟨hpq, hqp, hpq'⟩
