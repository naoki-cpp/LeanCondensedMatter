...
private theorem
    ...
    mixedTimeOrderedAtomicFieldFamily i j τ τ' d.vertexLabelSequence σ
        (d.1.externalPieceMixedPosition τ τ' σ p) =
      mixedTimeOrderedAtomicFieldFamily i j τ τ' d.externalPiece.vertexLabelSequence
    ...
    _ = ∏ v : ↥(Finset.univ : Finset (Fin d.1.externalInteractionPart.card)),
      ...
      calc
        g (d.1.vertexLabel ⟨v.1, Finset.mem_univ _⟩) =
          ...
          apply Subtype.ext
          have h := Common.standardSlotEquivOfCardEq_symm_coe
            d.1.externalInteractionPart rfl (e v)
          simpa [e, Common.standardSlotEquiv] using h
