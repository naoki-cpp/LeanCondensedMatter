...
ambient vacuum pairs are the dependent sum of the mixed pair fibers of the vacuum components; those
fibers have twice the corresponding interaction-component cardinality; and
...
noncomputable def FixedExternalTwoPointWickDiagram.mixedVacuumPairSigmaEquiv
    (d : FixedExternalTwoPointWickDiagram Mode n i j)
    (τ τ' : ℝ) (σ : Fin n → ℝ) :
    (Σ B : ↥d.1.vacuumComponentParts, d.MixedComponentPair τ τ' σ B.1) ≃
