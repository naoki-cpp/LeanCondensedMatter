...
Kubo–Greenwood/Bastin/Středa, Ward, finite-table evaluation, and finite-disorder adapters. Generic
reusable response, occupation, resolvent, trace, and Středa integration theory remains under
`QuantumTheory`.
